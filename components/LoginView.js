...
export default class LoginView extends Component {
    ...
    //Loginview til at teste appen - kræver ikke input. Rigtig login funktion findes i bunden.
    GoNext = () => {
        this.props.navigation.navigate('MapView');
    };

    //Render indeholder input bokse og logind knap
    render() {
        return (
                <View>
                ...
                <View style={styles.page}>
                    ...
                    <Button
                        title = "Log ind" onPress={this.GoNext}>
                    </Button>
...
//Rigtig login funktion når appen skal lanceres.
/*
